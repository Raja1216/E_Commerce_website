...
while ($row_cart=mysqli_fetch_array($run_cart)) {
	...
	while ($row_pro=mysqli_fetch_array($run_pro)) {
	 ...
	 $insert_cust= "INSERT INTO customer_order ( customer_id,product_id,due_amount, invoice_no, qty, size, order_date, order_status) VALUES ( '$customer_id', '$pro_id', '$sub_total', '$invoice_no', '$qty', '$size', current_timestamp(), '$status')";
	...
	/*$insert_pending_order="insert into pending_order (customer_id,invoice_no,product_id,qty,size,order_status) values('$customer_id','$invoice_no','$pro_id','$qty','$size','$status')";
	  $run_p_order=mysqli_query($con,$insert_pending_order);*/
