...
<div class="col-lg-3 col-md-6"><!--box start-->
...
<div class="col-xs-9 text-right">
<div class="huge"><?php echo $count_p_cust ?></div>
<div>Product Categories</div>
</div>	
</div>	
</div>
<a href="index_admin.php?view_product_cat">
<div class="panel-footer">
<span class="pull-left"> View Details </span>
<span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
<div class="clearfix"></div>	
...
<div class="col-lg-3 col-md-6" id="boxst"><!--box start-->
...
<img src="admin_images/<?php echo $admin_image ?>" class="img-thumbnail img-responsive">
