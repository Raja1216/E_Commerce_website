...
<div class="form-group">
<label class="col-md-3" control-label>Product Categories Description</label>
<div class="col-md-6">	
...
if (isset($_POST['update'])) {
	...
	if ($run_p_cat) {
		echo "<script> alert('Product Category Edit Sucessfully')</script>";
		echo " <script> window.open('index_admin.php?view_p_cat','_self')</script>";
	}
}
?>
<?php } ?>